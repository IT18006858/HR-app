...
class CountriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'country_name' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'countries_ibfk_1' => ['type' => 'foreign', 'columns' => ['region_id'], 'references' => ['regions', 'region_id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
