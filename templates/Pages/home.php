            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="column">
                        <h4>TOOLS</h4>
                        <ul>
                            <li class="bullet success" > <a  href="http://localhost/HR-system/hrApp/countries"> Country managemnt  </a></li>
                            ...
                            <li class="bullet success" > <a  href="http://localhost/HR-system/hrApp/regions"> Region managemnt  </a></li>
