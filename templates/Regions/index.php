        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $region->region_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $region->region_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $region->region_id], ['confirm' => __('Are you sure you want to delete # {0}?', $region->region_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
